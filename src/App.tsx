    ...
    const newBill: BillRecord = {
      ...
      shares: result.shares.map(s => {
        ...
        return {
          ...
          gameDiscountPercent: s.gameDiscountPercent,
          gameDiscountAmount: s.gameDiscountAmount,
          netGameShare: s.netGameCostShare,
          barShare: s.barCostShare,
          barDiscountPercent: s.barDiscountPercent,
          barDiscountAmount: s.barDiscountAmount,
          netBarShare: s.netBarCostShare,
          ...
          isWinner,
          isHost,
          membershipBadge: s.membershipBadge,
          notes: s.notes,
        };
      }),
      barItemsSummary: targetSession?.attachedBarOrders?.map(o => ({
