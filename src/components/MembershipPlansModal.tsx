              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    <IndianRupee className="w-3.5 h-3.5 absolute left-3 top-1/2 -translate-y-1/2 text-slate-500" />
                    <input
                      type="number"
                      required
                      min="0"
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex gap-1.5">
                    ...
                    <input
                      ...
                      className={`w-16 px-2 py-1.5 text-xs text-center rounded-lg border font-mono ${
                        isDarkMode ? 'bg-slate-900 border-slate-700 text-white' : 'bg-white border-slate-300 text-slate-900'
                      }`}
                    />
                  </div>
                ...
                <div className={`p-3.5 rounded-xl border sm:col-span-2 space-y-2 ${
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <span className="text-xs font-bold block text-amber-400">Game Table Discount Percentage</span>
                      <span className="text-[11px] text-slate-400">
                        Automatically deducted from member's calculated game share (1v1, 2v2, LP, or Solo)
                      </span>
                    </div>
                    <div className="flex items-center gap-1 bg-amber-500/10 border border-amber-500/30 px-3 py-1 rounded-xl">
                      <span className="text-base font-black font-mono text-amber-400">{gameDiscountPercent}%</span>
                      <span className="text-[10px] text-amber-300/80 font-bold uppercase">OFF</span>
                    </div>
                  </div>
                ...
                <div className={`p-3.5 rounded-xl border sm:col-span-2 space-y-2 ${
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <span className="text-xs font-bold block text-slate-300">Snack & Cafe Discount (Optional)</span>
                      <span className="text-[11px] text-slate-400">
                        Optional perk for food, beverages, and hookah orders
                      </span>
                    </div>
                    <div className="flex items-center gap-1 bg-slate-800 border border-slate-700 px-3 py-1 rounded-xl">
                      <span className="text-xs font-black font-mono text-slate-200">{barDiscountPercent}%</span>
                    </div>
                  </div>
                      ...
                      <div>
                        ...
                        <div className="flex items-start justify-between gap-2 mb-2">
                          <div className="space-y-1">
                            ...
                            <div className="text-xs font-mono font-bold text-amber-400">
                              ₹{plan.price.toLocaleString('en-IN')} <span className="text-[10px] text-slate-400 font-normal">/ {plan.durationDays} days</span>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            <button
                              ...
                              className="p-1.5 rounded-lg text-red-400/80 hover:text-red-400 hover:bg-red-500/10 transition cursor-pointer"
                              title="Delete Plan"
                            >
                        ...
                        <div className="grid grid-cols-2 gap-2 my-3">
                          <div className={`p-2.5 rounded-xl border text-center ${
                            ...
                            <span className="text-[10px] block font-semibold text-slate-400">Game Discount</span>
                            <span className="text-base font-black font-mono">{plan.gameDiscountPercent}% OFF</span>
                          </div>

                          <div className={`p-2.5 rounded-xl border text-center ${
                            isDarkMode ? 'bg-slate-900 border-slate-800 text-slate-300' : 'bg-slate-50 border-slate-200 text-slate-700'
                          }`}>
                            <span className="text-[10px] block font-semibold text-slate-400">Active Members</span>
