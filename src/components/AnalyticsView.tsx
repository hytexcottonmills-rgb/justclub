    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <button
            ...
            className="px-3 sm:px-3.5 py-1.5 sm:py-2 bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold rounded-xl shadow-md flex items-center gap-1.5 transition cursor-pointer"
          >
            <Printer className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
            <span className="hidden sm:inline">Print P&L Statement</span>
      ...
      <div id="analytics-subtabs-nav" className={`flex items-center gap-2 border-b pb-2 overflow-x-auto scrollbar-none flex-nowrap ${
        ...
        <button
          ...
          className={`px-3 sm:px-4 py-2 rounded-xl text-xs font-bold transition flex items-center gap-2 shrink-0 whitespace-nowrap cursor-pointer ${
        ...
        >
          ...
          <span className="hidden sm:inline">Revenue & Profit Reports</span>
          <span className="sm:hidden">Revenue & P&L</span>
        </button>
        ...
        >
          ...
          <span className="hidden sm:inline">Customer Retention & Churn</span>
      ...
      {activeSubTab !== 'retention' && (
        <div className={`p-2.5 sm:p-3 rounded-2xl border space-y-2.5 ${
          isDarkMode ? 'bg-slate-950/80 border-slate-800' : 'bg-slate-100 border-slate-200'
        }`}>
          <div className="flex items-center gap-1.5 overflow-x-auto scrollbar-none py-0.5">
            <div className="hidden sm:flex items-center gap-1.5 text-xs font-bold text-slate-400 shrink-0 mr-1">
