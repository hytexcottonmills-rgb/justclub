...
export const BillInvoicePrintModal: React.FC<BillInvoicePrintModalProps> = ({
  ...
  const handleCopySummary = () => {
    ...
    const summaryText =
      ...
      (bill.roundOffAmount !== undefined && bill.roundOffAmount !== 0 ? `Round Off: ${bill.roundOffAmount > 0 ? '+' : ''}Rs. ${bill.roundOffAmount.toFixed(2)}\n` : '') +
  ...
  const getWhatsAppInvoiceLink = (specificPlayerId?: string) => {
    ...
    if (bill.roundOffAmount !== undefined && bill.roundOffAmount !== 0) {
              ...
              >
                ...
                <div className="p-3 bg-slate-50 rounded-lg border-2 border-slate-300 flex items-center justify-between gap-4 mb-4">
                  <div className="space-y-1 text-xs">
                    ...
                    {bill.roundOffAmount !== undefined && bill.roundOffAmount !== 0 && (
                      <div className="text-slate-600">
